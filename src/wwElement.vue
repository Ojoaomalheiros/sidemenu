  ...
  setup(props, { emit }) {
    ...
    const getIconSvg = (iconName) => {
      const icons = {
        ...
        send: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12l14-6-6 14-2-6-6-2z"/><path d="M5 12l6 2 2-8"/></svg>',
